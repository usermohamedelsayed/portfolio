            ...
            <div className="container">
                <div className="details">
                    <div className="boxImg">
                        <img onError={handleErrorImg} loading="lazy" className="myImg" src={myImage} alt="my_image" />
                        <img onError={handleErrorImg} className="imgMark" src={imgMark} alt="my_image" />
                    </div>
                    <div className="info motionTitle">
